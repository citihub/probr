...
func setFromEnvOrDefaults(e *CVars) {
...
// set fetches the env var or sets the default value as needed for the specified field from CVars
func (e *CVars) set(field interface{}, varName string, defaultValue interface{}) {
	switch v := field.(type) {
	default:
