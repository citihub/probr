...
var (
	tags = map[string][]string{
		...
		"@standard/cis/gke/v1.6.0/6.10.1":              []string{"k-gen-001"},
		...
		"@control_type/inspection":                     []string{"k-gen-001"},
		"@standard/citihub/CHC2-IAM105":                []string{"k-iam", "k-psp"},
		"@standard/citihub/CHC2-ITS115":                []string{"k-gen-001"},
